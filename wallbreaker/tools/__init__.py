...
def build_registry(config: Config, cwd: str | None = None) -> ToolRegistry:
    ...
    for module_name in (
        ...
        "campaign", "leaderboard", "leak_scan", "judge_selftest", "frr_scan", "seed_sweep",
        ...
        "cluster_findings",
        "typographic", "session_card", "rag_poison", "memory_poison", "agentharm", "agentbench", "worm_wrap", "rug_pull", "fingerprint_defense",
